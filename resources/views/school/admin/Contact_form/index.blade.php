                    ...
                    <div class="pagetitle">
                        ...
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Manage-contactForm</li>
                            </ol>
                        </nav>
                    </div><!-- End Page Title -->
                                        ...
                                        <tbody>
                                            @foreach ($contactForms as $contactForm)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('contactForm.edit', $contactForm->id) }}"
                                                            class="btn btn-md btn-primary"><i class="fa fa-pencil"
                                                                aria-hidden="true"></i></a>
                                                        <a href="{{ route('contactForm.show', $contactForm->id) }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form
                                                                            action="{{ route('contactForm.destroy', $contactForm->id) }}"
