                ...
                <div class="container-fluid p-4">
                    ...
                    <div class="pagetitle">
                        <div class="d-flex justify-content-between">
                            <h1>Add</h1>
                            <a href="{{ route('award.index') }}" class="btn btn-primary btn-md "><i class="fa fa-bars"
                                ...
                                <div class="card-body">
                                    <form action="{{ route('award.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    <label for="exampleFormControlTrophyName1"
                                                        class="form-label">TrophyName</label>
                                                    <input type="text" class="form-control"
                                                        id="exampleFormControlTrophyName1" aria-describedby="trophyNameHelp"
                                                        name="trophyName">
                                                    @error('trophyName')
                                                        <small>{{ $message }}</small>
                                                    @enderror
