                ...
                <div class="container-fluid p-4">
                    <div class="pagetitle">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{{ route('direction.create') }}" class="btn btn-primary btn-md "><i class="fa fa-plus"
                                    aria-hidden="true"></i></a>
                        </div>
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Home</a></li>
                                <li class="breadcrumb-item active">Manage-direction</li>
                            </ol>
                        </nav>
                    </div><!-- End Page Title -->
                                        ...
                                        <tbody>
                                            @foreach ($directions as $direction)
                                                <tr>
                                                    ...
                                                    <td>{{ $direction->logo }}</td>
                                                    <td>
                                                        <a href="{{ route('direction.edit', $direction->id) }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form
                                                                            action="{{ route('direction.destroy', $direction->id) }}"
