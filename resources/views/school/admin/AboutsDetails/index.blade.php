                ...
                <div class="container-fluid p-4">
                    <div class="pagetitle">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{{ route('aboutDetail.create') }}" class="btn btn-primary btn-md "><i
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <table
                                        ...
                                        <tbody>
                                            @foreach ($aboutsDetails as $aboutDetail)
                                                <tr>
                                                    <th scope="row">{{ $loop->iteration }}</th>
                                                    <td>{{ $aboutDetail->title }}</td>
                                                    <td>{{ $aboutDetail->description }}</td>
                                                    <td><img src="{{ asset('uploads/' . $aboutDetail->img) }}"
                                                            width="120px" height="100px" alt="no"></td>
                                                    <td>
                                                        <a href="{{ route('aboutDetail.edit', $aboutDetail->id) }}"
                                                            class="btn btn-md btn-primary"><i class="fa fa-pencil"
                                                                aria-hidden="true"></i></a>
                                                        <a href="{{ route('aboutDetail.show', $aboutDetail->id) }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form
                                                                            action="{{ route('aboutDetail.destroy', $aboutDetail->id) }}"
