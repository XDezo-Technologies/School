                ...
                <div class="container-fluid p-4">
                    ...
                    <div class="pagetitle">
                        <div class="d-flex justify-content-between">
                            <h1>Edit</h1>
                            <a href="{{ route('gallery.index') }}" class="btn btn-primary btn-md ">Back</a>
                        </div>
                        <nav>
                            <ol class="breadcrumb">
                    ...
                    <section class="section">
                        <div class="row">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('gallery.show', $galleries->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                ...
                                                <img src="/uploads/{{ $galleries->img }}" width="120px" height="60px"
                                                    alt="no" class="m-2">
                                                <div class="input-group mb-3 col">
                                                    <input id="imagebox" type="text" class="form-control" disabled
                                                        name="img" readonly value="{{ $galleries->img }}">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                                        ...
                                                        value="{{ $galleries->title }}"> @error('title')
                                                        <small>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            </div>
